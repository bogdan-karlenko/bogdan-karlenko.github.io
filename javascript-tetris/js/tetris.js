...
function setPieces(pieces) {
	for (piece in pieces) {
		switch (pieces[piece].name) {
			case "i": pieces[piece].size = 4; pieces[piece].color = "cyan"; break;
			case "j": pieces[piece].size = 3; pieces[piece].color = "blue"; break;
			case "l": pieces[piece].size = 3; pieces[piece].color = "orange"; break;
			case "o": pieces[piece].size = 2; pieces[piece].color = "pink"; break;
			case "s": pieces[piece].size = 3; pieces[piece].color = "green"; break;
			case "t": pieces[piece].size = 3; pieces[piece].color = "purple"; break;
			case "z": pieces[piece].size = 3; pieces[piece].color = "red"; break;
		}
	}
	return pieces;
}
...
var pieces = [{name:"i", rotStage:0, body:[	"0#00",
			  ...
			  {name:"j", rotStage:0, body:[	"0#0",
											"0#0",
											"##0"]},

			  {name:"j", rotStage:1, body:[	"#00",
											"###",
											"000"]},

			  {name:"j", rotStage:2, body:[	"0##",
											"0#0",
											"0#0"]},

			  {name:"j", rotStage:3, body:[	"000",
											"###",
											"00#"]},

			  {name:"l", rotStage:0, body:[	"0#0",
											"0#0",
											"0##"]},

			  {name:"l", rotStage:1, body:[	"000",
											"###",
											"#00"]},

			  {name:"l", rotStage:2, body:[	"##0",
											"0#0",
											"0#0"]},

			  {name:"l", rotStage:3, body:[	"00#",
											"###",
											"000"]},

			  {name:"o", rotStage:0, body:[	"##",
											"##"]},

			  {name:"o", rotStage:1, body:[	"##",
											"##"]},
											
			  {name:"o", rotStage:2, body:[	"##",
											"##"]},
											
			  {name:"o", rotStage:3, body:[	"##",
											"##"]},
											
			  {name:"s", rotStage:0, body:[	"000",
											"0##",
											"##0"]},

			  {name:"s", rotStage:1, body:[	"#00",
			  								"##0",
			  								"0#0"]},

			  {name:"s", rotStage:2, body:[	"0##",
			  								"##0",
			  								"000"]},

			  {name:"s", rotStage:3, body:[	"0#0",
			  								"0##",
			  								"00#"]},

			  {name:"t", rotStage:0, body:[	"000",
											"###",
											"0#0"]},

			  {name:"t", rotStage:1, body:[	"0#0",
			  								"##0",
			  								"0#0"]},

			  {name:"t", rotStage:2, body:[	"0#0",
			  								"###",
			  								"000"]},

			  {name:"t", rotStage:3, body:["0#0",
			  							   "0##",
			  							   "0#0"]},

			  {name:"z", rotStage:0, body:["000",
										   "##0",
										   "0##"]},

			  {name:"z", rotStage:1, body:["0#0",
			  							   "##0",
			  							   "#00"]},

			  {name:"z", rotStage:2, body:["##0",
			  							   "0##",
			  							   "000"]},

			  {name:"z", rotStage:3, body:[	"00#",
			  								"0##",
			  								"0#0"]}];